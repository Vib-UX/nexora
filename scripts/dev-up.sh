...
echo "  Explorer: http://localhost:3000/tx/<hash>  (in-dashboard, primary)"
echo "  Optional: docker compose -f chain/docker-compose.yml --profile explorer up -d"
echo "            -> http://localhost:4001  (Blockscout, additive; see docs/blockscout.md)"
echo
